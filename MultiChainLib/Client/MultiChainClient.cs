...
/*, nativeAmount, comment,
                ...
                {
                    return ExecuteAsync<string>("issuefrom", 0, fromAddress, toAddress, assetName, quantity, units); /*, nativeAmount, comment,
                commentTo, startBlock, endBlock);*/
                }
                    ...
                    string commentTo = null, int startBlock = 0, int endBlock = 0)
                {
                    ...
                    var permissionsAsString = FormatPermissions(permissions);
                    return ExecuteAsync<string>("grant", 0, stringifiedAddresses, permissionsAsString); /*, nativeAmount, comment ?? string.Empty, 
                    ...
                    string commentTo = null, int startBlock = 0, int endBlock = 0)
                {
                    var stringifiedAddresses = StringifyValues(addresses);
                    var permissionsAsString = FormatPermissions(permissions);
                    return ExecuteAsync<string>("revoke", 0, stringifiedAddresses, permissionsAsString); /*, nativeAmount, comment ?? string.Empty, 
                commentTo ?? string.Empty, startBlock, endBlock);*/
                }
                    ...
                    string comment = null, string commentTo = null, int startBlock = 0, int endBlock = 0)
                {
                    ...
                    var permissionsAsString = FormatPermissions(permissions);
                    return ExecuteAsync<string>("grantfrom", 0, fromAddress, stringifiedAddresses, permissionsAsString); /*, nativeAmount, comment ?? string.Empty, 
                commentTo ?? string.Empty, startBlock, endBlock);*/
                }
                    ...
                    string comment = null, string commentTo = null, int startBlock = 0, int endBlock = 0)
                {
                    var stringifiedAddresses = StringifyValues(toAddresses);
                    var permissionsAsString = FormatPermissions(permissions);
                    return ExecuteAsync<string>("revokefrom", 0, fromAddress, stringifiedAddresses, permissionsAsString); /*, nativeAmount, comment ?? string.Empty, 
                commentTo ?? string.Empty, startBlock, endBlock);*/
                }
                ...
                {
                    return ExecuteAsync<string>("sendfrom", 0, fromAccount ?? string.Empty, toAddress, amount, confirmations, comment ?? string.Empty, commentTo ?? string.Empty);
                }
                ...
                {
                    return ExecuteAsync<List<AssetBalanceResponse>>("getassetbalances", 0, account ?? string.Empty, confirmations, watchOnly, includeLocked);
                }
                ...
                {
                    return ExecuteAsync<List<AssetBalanceResponse>>("getaddressbalances", 0, address, confirmations, includeLocked);
                }
